...
class PrivacyPolicyScreen extends StatelessWidget {
  ...
  Widget _buildSection(
      ColorScheme colorScheme, String title, String content, bool isDark) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        if (title.isNotEmpty) ...[
  ...
  Widget _buildSubSection(
      ColorScheme colorScheme, String title, List<String> items, bool isDark) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
  ...
  Widget _buildBulletList(
      ColorScheme colorScheme, List<String> items, bool isDark) {
    return Column(
      children: [
        ...items.map((item) => Padding(
